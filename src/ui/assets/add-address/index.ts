export { ReactComponent as RcAddAddressOptionCreateIcon } from './option-create.svg';
export { ReactComponent as RcAddAddressOptionSeedPhraseIcon } from './option-seed-phrase.svg';
...
export { ReactComponent as RcAddMoreAddressesCheckmarkIcon } from './add-more-radio-checkmark.svg';
export { ReactComponent as RcAddMoreAddressesUncheckedIcon } from './add-more-radio-unchecked.svg';
export { ReactComponent as RcAddMoreAddressesSheetOuterIcon } from './add-more-sheet-radio-outer.svg';
export { ReactComponent as RcAddMoreAddressesSheetInnerIcon } from './add-more-sheet-radio-inner.svg';
